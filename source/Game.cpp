...
void CGame::Initialize()
{
	...
	case GAMETYPE_NORMAL:	
		...
		m_mapArray[MAP_CELLAR] = new CMap(map_cellarTiles, map_cellarTilesLen, map_cellarMap, map_cellarMapLen, map_cellarPal, map_cellarPalLen);
		m_mapArray[MAP_CLOCK] = new CMap(map_clockTiles, map_clockTilesLen, map_clockMap, map_clockMapLen, map_clockPal, map_clockPalLen);
		m_mapArray[MAP_DRAWING] = new CMap(map_drawingTiles, map_drawingTilesLen, map_drawingMap, map_drawingMapLen, map_drawingPal, map_drawingPalLen);
		m_mapArray[MAP_HALL1] = new CMap(map_hall1Tiles, map_hall1TilesLen, map_hall1Map, map_hall1MapLen, map_hall1Pal, map_hall1PalLen);
		m_mapArray[MAP_HALL2] = new CMap(map_hall2Tiles, map_hall2TilesLen, map_hall2Map, map_hall2MapLen, map_hall2Pal, map_hall2PalLen);
		m_mapArray[MAP_HALL3] = new CMap(map_hall3Tiles, map_hall3TilesLen, map_hall3Map, map_hall3MapLen, map_hall3Pal, map_hall3PalLen);
		m_mapArray[MAP_HALL4] = new CMap(map_hall4Tiles, map_hall4TilesLen, map_hall4Map, map_hall4MapLen, map_hall4Pal, map_hall4PalLen);
		m_mapArray[MAP_KITCHEN] = new CMap(map_kitchenTiles, map_kitchenTilesLen, map_kitchenMap, map_kitchenMapLen, map_kitchenPal, map_kitchenPalLen);
		m_mapArray[MAP_LANDING] = new CMap(map_landingTiles, map_landingTilesLen, map_landingMap, map_landingMapLen, map_landingPal, map_landingPalLen);
		m_mapArray[MAP_LIBRARY] = new CMap(map_libraryTiles, map_libraryTilesLen, map_libraryMap, map_libraryMapLen, map_libraryPal, map_libraryPalLen);
		m_mapArray[MAP_OUTSIDE1] = new CMap(map_outside1Tiles, map_outside1TilesLen, map_outside1Map, map_outside1MapLen, map_outside1Pal, map_outside1PalLen);
		m_mapArray[MAP_OUTSIDE2] = new CMap(map_outside2Tiles, map_outside2TilesLen, map_outside2Map, map_outside2MapLen, map_outside2Pal, map_outside2PalLen);
		m_mapArray[MAP_PASSAGE1] = new CMap(map_passage1Tiles, map_passage1TilesLen, map_passage1Map, map_passage1MapLen, map_passage1Pal, map_passage1PalLen);
		m_mapArray[MAP_PASSAGE2] = new CMap(map_passage2Tiles, map_passage2TilesLen, map_passage2Map, map_passage2MapLen, map_passage2Pal, map_passage2PalLen);
		m_mapArray[MAP_ROOM1] = new CMap(map_room1Tiles, map_room1TilesLen, map_room1Map, map_room1MapLen, map_room1Pal, map_room1PalLen);
		m_mapArray[MAP_ROOM2] = new CMap(map_room2Tiles, map_room2TilesLen, map_room2Map, map_room2MapLen, map_room2Pal, map_room2PalLen);
		m_mapArray[MAP_STAIRS] = new CMap(map_stairsTiles, map_stairsTilesLen, map_stairsMap, map_stairsMapLen, map_stairsPal, map_stairsPalLen);
		m_mapArray[MAP_STUDY] = new CMap(map_studyTiles, map_studyTilesLen, map_studyMap, map_studyMapLen, map_studyPal, map_studyPalLen);
