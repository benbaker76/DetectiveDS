...
enum EventFlag
{
	...
	EVENTFLAG_HALL1 = BIT(1),
	EVENTFLAG_HALL3 = BIT(2),
	EVENTFLAG_MURDER_DINGLE = BIT(3),
	EVENTFLAG_MURDER_CYNTHIA = BIT(4),
	EVENTFLAG_MURDER_DOCTOR = BIT(5),
	EVENTFLAG_MURDER_GABRIEL = BIT(6),
	EVENTFLAG_WITNESS_MURDER_DINGLE = BIT(7),
	EVENTFLAG_WITNESS_MURDER_CYNTHIA = BIT(8),
	EVENTFLAG_WITNESS_MURDER_DOCTOR = BIT(9),
	EVENTFLAG_WITNESS_MURDER_GABRIEL = BIT(10),
	EVENTFLAG_PLACE_KNIFE = BIT(11),
	EVENTFLAG_REMOVE_BULLETS = BIT(12)
};
